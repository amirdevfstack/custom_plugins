...
== Description ==
A testing payment gateway for WooCommerce to see if your checkout works like it should. You can complete a full and real checkout on your site to see if everything is running smoothly. Runs for admin users only.
...
* Complete a full and real checkout with no payment
== Installation ==
...
= Do I need a WooCommerce plugin installed for this to work =
YES.  This sets up a test gateway for WooCommerce only.
== Screenshots ==
1. This is the settings page withing WooCommerce setting area
2. Checkout notice
== Changelog ==

= 3.2 June 14th, 2024  =
* Corrected activation hook
= 3.1 June 13th, 2024  =
* Corrected security issue
= 3.0 June 13th, 2024  =
* Adjust to work with newest version of WooCommerce
= 2.1 May 26th, 2022  =
* Adjust to work well with WordPress 6.0 release
= 2.0 May 19th, 2022  =
* Update to get ready for WordPress 6.0
= 1.4 August 10, 2016  =
...
* Update to run on the newest version of WordPress core.
