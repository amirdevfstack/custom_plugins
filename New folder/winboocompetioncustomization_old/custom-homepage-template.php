...
// Section 2 Settings
$section2_bg_image_id = get_theme_mod('win_boo_homepage_section2_bg_image');
$section2_bg_image_url = wp_get_attachment_url($section2_bg_image_id);
$section2_title = get_theme_mod('win_boo_homepage_section2_title', __('UNSERE ZIEL IST ES,<span>JEDEN</span> ZUM <span>GEWINNER</span>ZU MACHEN', 'win-boo'));
$section2_paragraph = get_theme_mod('win_boo_homepage_section2_paragraph', __('Wir haben Uhren im Wert von 1.395.745 € verschenkt. Weltweit Spitzenreiter für unschlagbare Gewinnchancen.', 'win-boo'));


get_header(); ?>

<div class="Custom-Rolex-Main">
         <div class="Custom-Rolex-Inner Page-Width">
            <div class="Custom-Rolex-Boxes">
               <div class="Custom-Rolex-Box">
                  <img src="<?php echo esc_url(site_url('/wp-content/uploads/2024/07/1.webp')); ?>">
                  <div class="Custom-Rolex-Data">
                     <div class="Custom-Rolex-Title">
                        <h1>ROLEX SKY-DWELLER</h1>
                        <h2>Bracelet jubile 26,000€</h2>
                     </div>
                     ...
                     <div class="Custom-Button-Data">
                        ...
                        <div class="Custom-Text-Data">
                           <a href="">Sichere dir dein Ticket →</a>
                        </div>
                     </div>
                  </div>
               </div>
    ...
    <div class="Custom-Background-Image-Inner" style="background-image: url('<?php echo esc_url($section2_bg_image_url); ?>');">
        <div class="Custom-Svg-Box">
            <div class="Custom-Svg-Title">
                <div class="Custom-Svg-Title-Inner">
                    <h1><?php echo wp_kses_post($section2_title); ?></h1>
                </div>
            </div>
            <div class="Custom-Svg-Title">
                <p><?php echo esc_html($section2_paragraph); ?></p>
            </div>
        </div>
    </div>
</div>
      ...
      <div class="text">
         <div class="slide-flexxx" style="width: 97%; margin: 0 auto;">
            <div class="container">
              
               <div class="slide">
                  <div class="custom-slider-wraper">
                     <div class="slide-aaaaa">
                        <img src="<?php echo esc_url(site_url('/wp-content/uploads/2024/07/1721538783657.webp')); ?>" alt="Winner 2">
                     </div>
                     <div class="slide-aaaaa-text">
                        <div class="pahla-flex" style="display: flex; padding: 20px;">
                           <div class="flex flex-col justify-center">
                              <span class="text-xl text-white" style="font-size: 1.25rem; line-height: 1.75rem; color: white;">Winner of NEW ROLEX GMT-MASTER II</span>
                              <br>
                              <span class="text-base font-medium text-stone-200">Michael Maklouf</span>
                           </div>
                           <div class="flex flex-col justify-center">
                              <span class="text-xl font-medium text-stone-200">£22k</span>
         ...
         <div class="buttons">
            <button class="previous">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-left h-[27.08px] w-[27.08px] md:h-[32.05px] md:w-[32.05px] text-primary group-hover:scale-125 duration-200 group-hover:text-secondary">
            ...
            <button class="next">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right h-[27.08px] w-[27.08px] md:h-[32.05px] md:w-[32.05px] text-primary group-hover:scale-125 duration-200 group-hover:text-secondary">
      ...
      <div class="Custom-Svg-Main">
         <div class="Custom-Svg-Inner">
            <div class="Custom-Svg-Box">
               <div class="Custom-Svg-Title">
                  <div class="Custom-Svg-Title-Inner">
                     <h1>
                        <span>How to</span>Enter the competition
                     </h1>
                  </div>
               </div>
               <div class="Custom-Svg-Title">
                  <p>Get a chance to win the next contest and get your dream watch.</p>
               </div>
            </div>
            <div class="Custom-Svg-Boxes">
                        ...
                        <div class="svg-line">
                           <svg role="image" viewBox="0 0 246 10" xmlns="http://www.w3.org/2000/svg" class="h-full w-full">
                              <svg role="image" viewBox="0 0 246 10" xmlns="http://www.w3.org/2000/svg" class=" h-full w-full">
                                 ...
                                 <line x1="20.5" y1="-2.18557e-08" x2="20.5" y2="10" stroke="#00D273"></line>
                                 ...
                                 <line x1="45.5" y1="-2.18557e-08" x2="45.5" y2="10" stroke="#00D273"></line>
                                 ...
                                 <line x1="70.5" y1="-2.18557e-08" x2="70.5" y2="10" stroke="#00D273"></line>
                                 ...
                                 <line x1="95.5" y1="-2.18557e-08" x2="95.5" y2="10" stroke="#00D273"></line>
                                 ...
                                 <line x1="120.5" y1="-2.18557e-08" x2="120.5" y2="10" stroke="#00D273"></line>
                                 ...
                                 <line x1="145.5" y1="-2.18557e-08" x2="145.5" y2="10" stroke="#00D273"></line>
                                 ...
                                 <line x1="170.5" y1="-2.18557e-08" x2="170.5" y2="10" stroke="#00D273"></line>
                                 ...
                                 <line x1="195.5" y1="-2.18557e-08" x2="195.5" y2="10" stroke="#00D273"></line>
                                 ...
                                 <line x1="220.5" y1="-2.18557e-08" x2="220.5" y2="10" stroke="#00D273"></line>
                                 ...
                                 <line x1="245.5" y1="-2.18557e-08" x2="245.5" y2="10" stroke="#00D273"></line>
                              </svg>
                           </svg>
                        </div>
                        <div class="circle circle-2">
                           <div class="svg-box">
                              <svg role="image" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" class="h-[30px] w-[30px]">
                                 <path d="M26.7607 11.6907C29.4131 13.1331 29.4131 16.8669 26.7607 18.3093L10.7458 27.0182C8.16794 28.42 5 26.5954 5 23.7089L5 6.29112C5 3.4046 8.16794 1.58003 10.7458 2.98184L26.7607 11.6907Z" fill="current"></path>
                              </svg>
                           </div>
                        </div>
                        <div class="svg-line">
      ...
      <div class="custom_main_watch_container">
         <div class="custom_inner_watch_container Page-Width">
            <div class="Custom-Svg-Box">
               ...
               <div class="Custom-Svg-Title Custom-Svg-Title1">
                  <p>Wir haben Uhren im Wert von 1.395.745 € verschenkt. Weltweit Spitzenreiter für unschlagbare Gewinnchancen.</p>
               </div>
            </div>
            <div class="custom_all-box-container">
               <div class="custom_winuwatch-main-item">
                  ...
                  <div class="custom_text_content">
                     <h3>DateJust WIMBLEDON 126334</h3>
                     <h4>Won 17.07.2024</h4>
                     <p>Value £14k</p>
                  </div>
               </div>
               <div class="custom_winuwatch-main-item">
            ...
            <div class="custom_watch_btn">
               <a href="">
                  Join the next compition 
      ...
      <div class="custom_main_random_container">
         <div class="Custom-Svg-Box">
            <div class="Custom-Svg-Title">
               <div class="Custom-Svg-Title-Inner">
                  <h1>
         ...
         <div class="Custom-Background-Image-Inner">
            <div class="Custom-Svg-Box">
               <div class="Custom-Svg-Title">
                  <div class="Custom-Svg-Title-Inner">
                     <h1>
                        UNSERE<span>MISSION</span>
                     </h1>
                  </div>
               </div>
               <div class="Custom-Svg-Title">
                  <p>Unser Beitrag um die Welt besser zu machen</p>
               </div>
            </div>
         </div>
      </div>

      <div class="Custom-Last-Image">
      <img src="<?php echo esc_url(site_url('/wp-content/uploads/2024/07/Ebene_26.png')); ?>" alt="Ebene 26.png">
